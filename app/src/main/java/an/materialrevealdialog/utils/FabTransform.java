...
public class FabTransform extends Transition {
    ...
    public Animator createAnimator(final ViewGroup sceneRoot,
        ...
        final Interpolator fastOutSlowInInterpolator =
                Utils.getFastOutSlowInInterpolator(sceneRoot.getContext());
        ...
        if (fromFab) {
            ...
            circularReveal.setInterpolator(
                    Utils.getFastOutLinearInInterpolator(sceneRoot.getContext()));
        } else {
            circularReveal = ViewAnimationUtils.createCircularReveal(view,
                    view.getWidth() / 2,
                    view.getHeight() / 2,
                    ...
                    endBounds.width() / 2);
            circularReveal.setInterpolator(
                    Utils.getLinearOutSlowInInterpolator(sceneRoot.getContext()));
        ...
        return new Utils.NoPauseAnimator(transition);
    }
